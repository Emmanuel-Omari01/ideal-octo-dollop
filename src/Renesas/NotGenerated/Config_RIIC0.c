...
#include "../general/r_cg_userdefine.h"
...
void R_Config_RIIC0_Create(void)
{
    ...
    RIIC0.ICBRL.BYTE = _F1_IIC0_SCL_LOW_LEVEL_PERIOD;
    RIIC0.ICBRH.BYTE = _F2_IIC0_SCL_HIGH_LEVEL_PERIOD;
    ...
    IPR(RIIC0, TXI0) = _09_IIC_PRIORITY_LEVEL9;
    IPR(RIIC0, TEI0) = _0A_IIC_PRIORITY_LEVEL10;
    IPR(RIIC0, RXI0) = _0A_IIC_PRIORITY_LEVEL10;
    IPR(RIIC0, EEI0) = _0A_IIC_PRIORITY_LEVEL10;
