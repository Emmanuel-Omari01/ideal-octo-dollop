...
/* Timeout Internal Counter Write Enable (TMWE) */
#define _00_IIC_TIMEOUT_INTERNAL_DISABLE             (0x00U) /* Disable timeout  Internal Counter Write */
#define _08_IIC_TIMEOUT_INTERNAL_ENABLE              (0x08U) /* Enable  Internal Counter Write */
...
// enum eCBType { error, readend, writeend};   // AME: enum for callback functions
