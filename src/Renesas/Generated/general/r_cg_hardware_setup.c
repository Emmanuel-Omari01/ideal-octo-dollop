...
// AME, DS:
// The following two functions are not used. However, they are required to suppress warning messages from the linker.
unsigned int getpid() {
    return 0;
}

int kill(__attribute__((unused)) int pid, __attribute__((unused)) int sig) {
    return 0;
}
/* End user code. Do not edit comment generated here */
