...
#if RSPI_CFG_USE_CHAN0 == 1
// AME remove R_BSP_PRAGMA_STATIC_INTERRUPT (rspi_spri0_isr, VECT(RSPI0, SPRI0))
...
* Return Value :    N/A
******************************************************************************/
// AME remove R_BSP_ATTRIB_STATIC_INTERRUPT directive
...
#if RSPI_CFG_USE_CHAN0 == 1
// AME remove R_BSP_PRAGMA_STATIC_INTERRUPT (rspi_spti0_isr, VECT(RSPI0, SPTI0))
...
* Return Value :    N/A
******************************************************************************/
// AME: static uncommented
void rspi_spei_isr_common(uint8_t channel)
{
...
||  defined(BSP_MCU_RX671) || defined(BSP_MCU_RX660) || defined(BSP_MCU_RX26T))
    ...
    #if RSPI_CFG_USE_CHAN0 == 1
    // AME remove R_BSP_PRAGMA_STATIC_INTERRUPT (rspi_spei0_isr, VECT(RSPI0, SPEI0))
 ...
 * Return Value : .
 *********************************************************************************************************************/
// AME remove R_BSP_ATTRIB_STATIC_INTERRUPT
void rspi_spei0_isr(void)
    {
...
******************************************************************************/
// AME: static uncommented
void rspi_spii_isr_common(uint8_t channel)
{
    uint8_t status_flags = (*g_rspi_channels[channel]).SPSR.BYTE;
    rspi_evt_t event = RSPI_EVT_ERR_UNDEF;
...
******************************************************************************/
    #if RSPI_CFG_USE_CHAN0 == 1
    // AME remove R_BSP_PRAGMA_STATIC_INTERRUPT (rspi_spii0_isr, VECT(RSPI0, SPII0))
 ...
 * Return Value : .
 *********************************************************************************************************************/
// AME remove R_BSP_ATTRIB_INTERRUPT
void rspi_spii0_isr(void)
    {
