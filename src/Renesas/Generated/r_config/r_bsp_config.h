...
*         : 29.09.2014 1.70    Added support for the 512K ROM size part.
*         : 06.02.2017 1.71    Amended the following macro definition comment
...
*                              Added support for the 384KB and 256KB ROM size.
*         : 27.07.2018 2.02    Deleted the following macro definition.
*                                - BSP_CFG_BOARD_REVISION
...
*         : 21.11.2023 4.03    Added the following macro definitions.
...
/* NOTE:
   The default settings are the same as when using RSKRX111.
...
/* Group name.
   ...
   11           = RX111 Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX111" /* Generated value. Do not edit this manually */
...
/* Peripheral Module Clock D Divider (PCKD).
   Available divisors = /1 (no division), /2, /4, /8, /16, /32, /64
*/
#define BSP_CFG_PCKD_DIV                (2) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_CONFIGURATOR_VERSION                (2210) /* Generated value. Do not edit this manually */
