...
#ifndef SRC_AME_PROJECT_TERMINAL_SCI_REGISTERCONTROL_REGISTERCONTROLLERSCI1_H_
#define SRC_AME_PROJECT_TERMINAL_SCI_REGISTERCONTROL_REGISTERCONTROLLERSCI1_H_

#include "../SciRegisterController.h"

namespace AME_SRC {

class RegisterControllerSci1: public SciRegisterController {
 public:
    RegisterControllerSci1();
    virtual ~RegisterControllerSci1();
...
#endif  // SRC_AME_PROJECT_TERMINAL_SCI_REGISTERCONTROL_REGISTERCONTROLLERSCI1_H_
